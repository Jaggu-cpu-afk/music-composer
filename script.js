...
const data = {
  happy: { song: "songs/happy.mp3", image: "images/happy.jpg" },
  sad: { song: "songs/sad.mp3", image: "images/sad.jpg" },
  angry: { song: "songs/angry.mp3", image: "images/angry.jpg" },
  neutral: { song: "songs/neutral.mp3", image: "images/neutral.jpg" }
};
...
function botReply(mood) {
  ...
  if (mood === "sad") return "It’s okay… I’m here 💙";
